...
from cosp_nas.evaluator import get_cand_err
from cosp_nas.utils import get_cand_flops, get_logger
...
class EvolutionSearcher(object):
    ...
    def search(self):
        self.logger.info('evaluator_seed = {}'.format(self.args.evaluator_seed))
